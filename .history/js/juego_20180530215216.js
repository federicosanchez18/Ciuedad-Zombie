...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png',400,300,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png',350,180,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png', 440,410,30,30,1),
    new Obstaculo('imagenes/valla_vertical.png',250,180,30,30,1),
    new Obstaculo('imagenes/bache.png',320,100,30,30,3),
    new Obstaculo('imagenes/bache.png',200,400,30,30,3),
    new Obstaculo('imagenes/bache.png',200,200,30,30,3),
    new Obstaculo('imagenes/bache.png',400,180,30,30,3)
   ],
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png',100,350, 10, 10, 4,{desdeX:0,hastaX:961,desdeY:0,hastaY:577}),
    new ZombieCaminante('imagenes/zombie2.png',150,490,10,10,2,{desdeX:0,hastaX:961,desdeY:0,hastaY:577}),
    new ZombieCaminante('imagenes/zombie3.png',90,270,10,10,7,{desdeX:0,hastaX:961,desdeY:0,hastaY:577}),
    new ZombieCaminante('imagenes/zombie4.png',400,380,10,10,5,{desdeX:0,hastaX:961,desdeY:0,hastaY:577}),
    new ZombieCaminante('imagenes/zombie1.png',320,180,10,10,4,{desdeX:0,hastaX:961,desdeY:0,hastaY:577}),
    new ZombieCaminante('imagenes/zombie2.png',180.90,10,10,2,{desdeX:0,hastaX:961,desdeY:0,hastaY:577}),
    new ZombieConductor('imagenes/zombie4.png',644,0,30,90,{desdeX:0,hastaX:961,desdeY:0,hastaY:577},'v'),
    new ZombieConductor('imagenes/zombie4.png',400,322,90,30,{desdeX:0,hastaX:961,desdeY:0,hastaY:577},'h'),
    new ZombieConductor('imagenes/zombie4.png',678,0,30,90,{desdeX:0,hastaX:961,desdeY:0,hastaY:577},'v')
